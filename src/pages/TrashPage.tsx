      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="delete-dialog-description">
            Are you sure you want to permanently delete "{note.noteTitle}"? This
          ...
          <Box mb={3}>
            <Alert severity="info">
              <Typography variant="body2">
                You have {deletedNotes.length} note
                {deletedNotes.length !== 1 ? "s" : ""} in trash. You can restore
